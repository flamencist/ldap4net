...
namespace LdapForNet.Native
{
    public static class LinuxNative
    {
        ...
        [DllImport(LIB_LDAP_PATH)]
        public static extern Native.LdapResultType ldap_result(SafeHandle ld, int msgid, int all, IntPtr timeout,ref IntPtr pMessage);
    ...
    public static class MacOsNative
    {
