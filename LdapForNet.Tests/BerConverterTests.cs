...
namespace LdapForNetTests
{
    public class BerConverterTests
    {
        ...
        public static IEnumerable<object[]> Encode_TestData()
        {
            ...
            yield return new object[] { "oXo", new object[] { null, new byte[] { 0, 1, 1, 0 }, new byte[0] }, new byte[] { 4, 0, 3, 4, 0, 1, 1, 0, 4, 0 } };
            yield return new object[] { "{XX}", new object[] { new byte[] { 1, 0, 0, 0 }, new byte[] { 0, 0, 0, 1 } }, new byte[] { 48, 132, 0, 0, 0, 12, 3, 4, 1, 0, 0, 0, 3, 4, 0, 0, 0, 1 } };
        ...
        {
            Assert.Throws<ArgumentNullException>("format", () => BerConverter.Encode(null, new object[0]));
        }
        ...
        public static IEnumerable<object[]> Decode_TestData()
        {
            ...
            yield return new object[] { "{BB}", new byte[] { 48, 132, 0, 0, 0, 18, 3, 6, 0, 1, 0, 1, 0, 1, 3, 8, 1, 0, 1, 0, 1, 0, 1, 0 }, new object[] { new byte[] { 0, 1, 0, 1, 0, 1 }, new byte[] { 1, 0, 1, 0, 1, 0, 1, 0 } } };
            yield return new object[] { "{BB}", new byte[] { 48, 132, 0, 0, 0, 12, 3, 4, 0, 0, 0, 0, 3, 4, 1, 1, 1, 1 }, new object[] { new byte[] { 0, 0, 0, 0 }, new byte[] { 1, 1, 1, 1 } } };
        ...
        public static IEnumerable<object[]> Encode_Decode_TestData()
        {
            ...
            yield return new object[] { "{XX}", "{BB}", new object[] { new byte[] { 0, 1, 0, 1, 0, 1 }, new byte[] { 1, 0, 1, 0, 1, 0, 1, 0 } } };
            yield return new object[] { "{XX}", "{BB}", new object[] { new byte[] { 0, 0, 0, 0 }, new byte[] { 1, 1, 1, 1 } } };
